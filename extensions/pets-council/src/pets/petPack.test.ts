...
const runtime={phase:'ready' as const,binary:'codex',message:'ready',models:[],thread:{phase:'ready' as const,message:'ready',thread:{id:'t'}},turn:{phase:'completed' as const,message:'done'}};
