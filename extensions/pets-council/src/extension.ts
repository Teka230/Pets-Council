...
type SimpleMessage=Readonly<{type:'refreshContext'|'openFolder'|'connectCodex'|'disconnectCodex'|'startCodexThread'|'resumeCodexThread'|'interruptCodexTurn'|'openContextGraph'|'clearContextGraph'|'openUsageSignals'|'browseCodexSessions'|'applyProductLayout'}>;
...
export function activate(context:vscode.ExtensionContext):void{
  ...
  const commands=[
    ...
    vscode.commands.registerCommand('petsCouncil.openSilenceTuningReport',()=>openCompanionSilenceReport(usageStore)),vscode.commands.registerCommand('petsCouncil.openContextGraph',()=>graphStore.open()),vscode.commands.registerCommand('petsCouncil.clearContextGraph',()=>graphStore.clear()),vscode.commands.registerCommand('petsCouncil.addOpenQuestion',()=>graphStore.addOpenQuestion()),vscode.commands.registerCommand('petsCouncil.resolveOpenQuestion',()=>graphStore.resolveOpenQuestion()),vscode.commands.registerCommand('petsCouncil.queryContextGraph',()=>graphStore.query()),vscode.commands.registerCommand('petsCouncil.supersedeDecision',()=>graphStore.supersedeDecision()),vscode.commands.registerCommand('petsCouncil.openUsageSignals',()=>usageStore.open())
  ];
