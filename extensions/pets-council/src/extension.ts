...
export function activate(context:vscode.ExtensionContext):void{
  ...
  const openCouncil=():void=>{showCouncilPanel(runtime,graphStore,usageStore,nativeOverlay,()=>activePetPack);void offerProductLayout(context);};
...
function showCouncilPanel(runtime:CodexRuntimeService,graphStore:SharedContextGraphStore,usageStore:SuggestionUsageSignalStore,nativeOverlay:NativeOverlayBridge,petPack:()=>PetPackManifest):void{
